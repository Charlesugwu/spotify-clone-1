...
<script>
  ...
  $(document).ready( function() {
    ...
    $(".playbackBar .progressBar").mousemove(function(e){
      if(mouseDown) {
        // set time of song depending on mouse
  ...
  function setRepeat() {
    repeat = !repeat;
    // same as: if(repeat == true) {
    //   repeat = false;
    // } else {
    //   repeat = true;
    // }

    var imageName = repeat ? "icons8-repeat-active.png" : "icons8-repeat.png";
    // if imageName equals repeat, do "repeat-active" else do "repeat"
  ...
  function setMute() {
    ...
    var imageName = audioElement.audio.muted ? "icons8-no_audio_filled.png" : "icons8-sound_filled.png";
  ...
  function setShuffle() {
    ...
    var imageName = shuffle ? "icons8-shuffle_active.png" : "icons8-shuffle.png";
  ...
  <div id="nowPlayingLeft">
    <div class="content">
      <span class="albumLink">
        <img role="link" tabindex="0" src="assets/images/album-cover/juliette.png" class="albumArtwork" alt="">
      </span>
      <div class="trackInfo">
        <span class="trackName" role="link" tabindex="0"><span></span></span>
